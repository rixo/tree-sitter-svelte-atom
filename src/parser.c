...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [203] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_debug_expr, 5),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_debug_expr, 5),
  ...
  [277] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_debug_expr, 4),
  [279] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_debug_expr, 4),
